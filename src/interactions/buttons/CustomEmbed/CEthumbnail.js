...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    let msgEmbed = new EmbedBuilder().setColor("F4D58D").setDescription("**Entrez un lien d'image direct**");
    ...
    collector.on("collect", (m) => {
      ...
      interaction.editReply({
        embeds: [msgEmbed.setDescription(`**Envoyez un nouveau lien pour remplacer l'image`)],
      });
